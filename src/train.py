...
from src.data_pipeline import run as run_data
from src.paths import dd, md, mlr, uri
...
def pp(ns, cs):
    return ColumnTransformer([("n", StandardScaler(), ns), ("c", oh(), cs)])
